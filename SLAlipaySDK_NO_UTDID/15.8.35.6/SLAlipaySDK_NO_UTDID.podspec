...
TODO: Add long description of the pod here.
 ...
 s.social_media_url = 'https://sweetloser.com'
  ...
  s.libraries             = 'z', 'c++'
  s.resource              = 'SLAlipaySDK_NO_UTDID/AlipaySDK-15.8.35.6/AlipaySDK.bundle'
  s.vendored_frameworks   = 'SLAlipaySDK_NO_UTDID/AlipaySDK-15.8.35.6/AlipaySDK.framework'
  s.requires_arc          = true
  s.dependency 'UTDID'
